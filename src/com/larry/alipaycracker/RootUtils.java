...
public class RootUtils {
	...
	private static final String dbPATH = "/data/data/com.eg.android.AlipayGphone/databases/alipayclient.db";
	...
	public static int hasDB() {
		boolean hasDB = findDB();
		if (!hasDB) {
			return 0;
		}
		else return 1 ; 
	...
	private static boolean findDB() {
		boolean ret = openFile(dbPATH).exists();
		if (!ret) {
			ret = openFile(dbPATH).exists();
		}
		return ret;
	}
